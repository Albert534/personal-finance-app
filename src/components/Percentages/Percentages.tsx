...
const Percentages = () => {
	...
	return (
		<>
			...
			<div className='mt-2'>Remaining Percentages : 0%</div>

				<div className='mt-1'>Monthly Salary : 40000000 MMK </div>
				...
				{percentages.map((percentage) => (
					<>
						...
						>
							...
							<div className='mt-2'>
								Total Balance:{' '}
								<span className='text-green-700 font-semibold ml-2 mt-0.5'>
